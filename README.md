...
아이와 함께 캐릭터를 만들고, 발견하고, 대결하고, 종이 카드로 인쇄해 볼 수 있는 로컬 전용 웹 앱입니다.
...
- `assets/seek.png`처럼 파일 이름의 대소문자가 바뀌지 않았는지 확인합니다.
...
- `app.js` — 카드 122장, 팩 12종, 대결, 레벨, 저장, 가져오기/내보내기 로직
- `assets/` — 프로젝트용으로 생성한 고품질 카드 일러스트 14장
